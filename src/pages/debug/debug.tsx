...
import {GetCubeIconDebug} from "../../components/cube/icon/cube_icon";
...
const Debug = () => {
    ...
    const list = [
        ...
        "cubing-icon-sq1",
        "unofficial-222bf",
        "unofficial-234567relay",
        "unofficial-23456relay",
        "unofficial-2345relay",
        "unofficial-234relay",
        "unofficial-333mts",
        "unofficial-666bf",
        "unofficial-777bf",
        "unofficial-curvycopter",
        "unofficial-fisher",
        "unofficial-fto",
        "unofficial-helicopter",
        "unofficial-kilominx",
        "unofficial-miniguild",
        "unofficial-mpyram",
        "unofficial-mskewb",
        "unofficial-mtetram",
        "unofficial-pyramorphix",
        "unofficial-redi",
    ]
    for (let i = 0; i < list.length; i++) {
        items.push(GetCubeIconDebug(list[i]))
    }
